...
const ListadoDelDia = () => {
  ...
  const esFechaDeHoy = (stringFecha) => {
  ...
  const listaEventos = eventos.filter(
    (evento) => evento !== undefined && esFechaDeHoy(evento.fecha)
  );

  return (
    <>
      <ListaEventos listaEventos={listaEventos}></ListaEventos>
    </>
  );
};

export default ListadoDelDia;
